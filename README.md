...
<tr>
  ...
  <td> В проекте проводится анализ поведения пользователей в мобильном приложении на подобии "Авито", в котором они продают свои вещи, размещая их на доске объявлений.
  </td>
  <td> data analyst, аналитик данных, аналитик, мобильные приложения </td>
</tr>
